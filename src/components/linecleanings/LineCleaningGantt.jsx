                                      ...
                                      {segments.length > 1 ? segments.map((seg, si) => {
                                        ...
                                        <div className="flex items-center px-1.5 min-w-0 overflow-hidden">
                                          <div className="min-w-0 overflow-hidden leading-none">
                                            ...
                                            <p className={cn("text-[8px] truncate opacity-70", color.text)}>{Math.round(block.effectiveHours * 60)}m · {block.isConcurrent ? (block.segments?.[0]?.workers ?? block.employeeCount) : bar.plannedEmployeeCount}p</p>
                                          </div>
                                        </div>
                                      )}
                                      </div>
